    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            const payload: Record<string, any> = {
                ...
                how_to_use: form.how_to_use ? form.how_to_use.split('\n').filter(Boolean) : null,
            ...
            <div className="max-w-4xl mx-auto">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div className="space-y-2">
                        <div className="w-48 h-7 bg-gray-800 rounded animate-pulse" />
                        <div className="w-64 h-4 bg-gray-800 rounded animate-pulse" />
                    </div>
                </div>
                {[1, 2, 3].map((i) => (
                    <div key={i} className="bg-[#161922] border border-gray-800 rounded-xl p-6 mb-6">
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p className="text-gray-400 text-sm mt-1">Update details for &quot;{form.name}&quot;</p>
                </div>
            </div>
                ...
                <section className="bg-[#161922] border border-gray-800 rounded-xl p-6">
                    ...
                    <div className="mb-6">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            {thumbnail && (
                                <button type="button" onClick={() => setThumbnail(null)} className="text-red-400 text-xs hover:text-red-300">
                                    Remove
                                </button>
                            )}
                        </div>
